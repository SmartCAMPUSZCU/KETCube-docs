...
% Do not include about.tex -- use it for appnotes only
...
\begin{versionhistory}
  \vhEntry{draft}{09.12.2017}{Jan Bělohoubek}{draft}
  \vhEntry{02/2018}{16.02.2018}{Jan Bělohoubek}{Initial documentation}
  \vhEntry{05/2018}{07.05.2018}{Jan Bělohoubek, Kryštof Vaněk, Matin Úbl}{Text review, minor fixes}
\end{versionhistory}
...
\raisebox{-\height}{\includegraphics[width=0.3\paperwidth]{ketCube_mainBoard_photo_fullQ.jpg}}
  ...
  \subsubsection{Main Board Pinout} \label{spec:TB}
   \begin{table*}[!ht]
    \hspace*{-4cm}
    \begin{tabular}{| p{2cm} | p{3cm} | p{7cm} |}
        ...
        \hline
        IO4 & PA5/PA0 & Configurable by J9 \\
        \hline
        \hline
...
\clearpage
\subsubsection{PCB Settings -- Solder Jumpers and Optional Parts}
   ...
   \begin{table*}[!ht]
    ...
    \begin{tabular}{| p{2cm} | p{1cm} | p{9cm} |}
        ...
        \hline
        \hline
        J1 \hfill $\bullet$ & 1 -- 2 & Connect PA8 to IO3\\
        \hline
        J2 \hfill $\bullet$ & 1 -- 2 & Enable power for the radio part of the MuRaTa module\\
        \hline
        J3 \hfill $\bullet$ & 1 -- 2 & MCU control of radio sleep mode (PA12)\\
        \hline
        J3 & 2 -- 3 & Turn the radio permanently ON \\
        \hline
        ...
        \hline
        J7 & 1 -- 2 & Connect Vref to IO3\\
        \hline
        J8 & 1 -- 2 & MCU control of radio sleep mode (PA5)\\
        \hline
        J9 \hfill $\bullet$ & 1 -- 2 & Connect PA5 to IO4\\
        \hline
        J9 & 2 -- 3 & Connect PA0 to IO4\\
        \hline
