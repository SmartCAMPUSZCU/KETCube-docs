...
% Use for docuent title and subtitle
\thisdoc[Introduction to KETCube] {KETCube Platform Release 0.2}

% this will occupy the last - "Thank you" - slide
\summary{
\begin{itemize}
  \item {\bf KETCube}: The Prototyping and Educational Platform for IoT:
...
\section{KETCube Project Overview}
% --- ToC ---
\usebeamertemplate{tocsection}
% -----------
