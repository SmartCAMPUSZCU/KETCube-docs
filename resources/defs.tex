...
\newenvironment{docCodeSnippetTitled}[1]
{
\par
\addvspace{0.5cm}
\subsubsection*{~\hspace{0.2cm}\textcolor{gray}{\Huge \faCogs\,}}
...
\vspace{-1.5cm}
\nopagebreak
\begin{tcolorbox}[breakable,colback=white,colframe=gray,width=\dimexpr\textwidth+32mm\relax,enlarge left by=-32mm, title = #1]
}
{
\end{tcolorbox}
}
