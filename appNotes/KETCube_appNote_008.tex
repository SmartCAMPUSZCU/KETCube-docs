...
\marginlabel{\captionof{figure}{Non-Volatile Data Memory (EEPROM) -- Secure Storage}\label{fig:cmd:get}}
\raisebox{-\height}{

\begin{tikzpicture}
  \node[draw,fill=SeaGreen1,    minimum height=5cm,minimum width = 5cm,yshift=0cm](10/5){Application Data};
  \node[draw,fill=SeaGreen3,minimum height=2cm,minimum width = 5cm,yshift=3.5cm](10/5){Bootloader};
