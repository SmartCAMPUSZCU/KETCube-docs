...
\node[draw,
    ...
    minimum height=1cm,
    align=center
] (block1) { 0x7F or command received\\in the time window\footnotemark\\on supported interface\footnotemark };
...
\node[draw,
    ...
    minimum height=3cm,
    align=center
] (block3) { Auto-baud rate sequence\\send ACK byte\footnotemark };
