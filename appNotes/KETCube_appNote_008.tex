...
\begin{enumerate}
  ...
  \item activate the read-out protection (Level 1),
...
\begin{table*}[!ht]
  ...
  \begin{tabular}{| p{3cm} | p{1.5cm} | p{1cm} | p{1cm} | p{1cm} | p{4.5cm} | }
      ...
      \hline
      Verify Flash CMAC & \texttt{0x0130} & 16 & 0 & 0 & Write application CMAC to verify the application memory signature; \texttt{0x01} is returned in the status field when success\\
      \hline
  \end{tabular}
  \addcontentsline{lot}{table}{Bootloader Special Commands}
  \label{tab:specCmd}
