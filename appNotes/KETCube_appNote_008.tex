...
\begin{table*}[!ht]
  ...
  \begin{tabular}{| p{4cm} | p{9cm} | }
      ...
      {\tt security\_t } \newline ({\tt uint16\_t }) & {\tt 0x0000} -- do not protect application/bootloader memory;\newline
                           {\tt 0x0001} -- application code/data memory readout protection, bootloader interface is open;\newline
                           {\tt 0x0002} -- application code/data memory readout protection, bootloader interface is password-locked;\newline
                           {\tt 0x0003} -- application code/data memory readout protection, bootloader interface is key-locked.\\
      \hline
