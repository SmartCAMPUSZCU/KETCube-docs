...
\begin{tikzpicture}
 ...
 \node[anchor=north west,yshift=4.0cm,xshift=-0.5cm,fill=white] {0};
 \node[anchor=north west,yshift=4.0cm,xshift=+3.75cm,fill=white] {4};
 \node[anchor=north west,yshift=4.0cm,xshift=+8.0cm,fill=white] {8};
 
 \node[anchor=north west,yshift=2.75cm,xshift=-0.5cm,fill=white] {8};
 \node[anchor=north west,yshift=1.75cm,xshift=-0.65cm,fill=white] {16};
 \node[anchor=north west,yshift=2.75cm,xshift=+8.05cm,fill=white] {16};
 \node[anchor=north west,yshift=1.75cm,xshift=+8.05cm,fill=white] {24};
 \node[anchor=north west,yshift=0.75cm,xshift=-0.65cm,fill=white] {24};
 \node[anchor=north west,yshift=0.75cm,xshift=+8.05cm,fill=white] {32};
\end{tikzpicture}
