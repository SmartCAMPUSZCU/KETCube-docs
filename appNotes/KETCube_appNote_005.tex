...
The remote terminal protocol is an application protocol built on top of any supported undelying general-purpose application protocol like MQTT. Thus, it is designed to contain only application-level logic. Each packet starts with a fixed-size header. Its structure is as follows.
